...
namespace FizzBuzzGameApi.Services
{
    public class SessionService : ISessionService
    {
        ...
        public async Task<SessionStateDto?> StartSessionAsync(StartSessionDto dto)
        {
            ...
            {
                throw new InvalidOperationException("Failed to start session.", ex);
            }
        }
        ...
        public async Task<SessionStateDto?> SubmitAnswerAsync(int id, SubmitAnswerDto dto)
        {
            try
            {
                ...
                var game = session.GameDefinition ?? throw new InvalidOperationException("Game definition not found for session.");
            ...
            {
                throw new InvalidOperationException($"Failed to submit answer for session {id}.", ex);
            }
        }
        ...
        public async Task<SessionStateDto?> GetSessionAsync(int id)
        {
            ...
            {
                throw new InvalidOperationException($"Failed to retrieve session {id}.", ex);
            }
        }
